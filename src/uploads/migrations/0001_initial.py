# Generated by Django 2.2.14 on 2020-08-03 16:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upload', models.FileField(help_text='mp3 format only', max_length=1024, upload_to='av/audio-albums/', validators=[uploads.validators.validate_audio])),
