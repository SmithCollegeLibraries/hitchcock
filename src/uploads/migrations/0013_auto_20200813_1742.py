...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('uploads', '0012_auto_20200813_1714'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='videovtttrack',
            name='label',
            field=models.CharField(blank=True, help_text="Optional - Users see this. Overrides the name in the user interface generated from the Type and Language fields. Don't use this unless you know what you are doing.", max_length=16, null=True),
        ),
